...
echo -e "${YELLOW}    
    ...
    - Configuro Idioma.
    - Configuro .vimrc.
    - Configuro dibujo con ASCII y mensaje de monitorización de bienvenida en /etc/bash.bashrc (opcional).
    - Configuro SNMP.
...
# comando : tyr
# compilador genérico para proyectos en Debian
# -------------------------------------------------------------------
echo "¿Quieres instalar mi comando tyr? (s/n):"
read -r restyr
...
echo 'echo "MMMMMMMMMMMWKo;;;;;;;;;:;::;;;:;::;;;::::::::::;;;;;;;;;;;;;;;;;;;:cdKNMMMMMMMMM"' >> /etc/bash.bashrc
echo 'echo "MMMMMMMMMMMWKo;;;;;;;;;;;;;;:;;;;;;:;;;;;;;;;::;;;;;;;;;;;;;;;;;:;:::cxXMMMMMMMM"' >> /etc/bash.bashrc
echo 'echo "MMMMMMMMMMMMXo:;:;;;;;;;;::;;;;;;;;;;;;;;;;;;:;::;;;;;;;;;;;;;;;:cdkoccxNMMMMMMM"' >> /etc/bash.bashrc
echo 'echo "MMMMMMMMMMMMNx:;;;;::;;;::;;;;;;;;;;;::lokXNKd::;;;;;;;;;;;;;;;;:xXXxc:oKMMMMMMM"' >> /etc/bash.bashrc
echo 'echo "MMMMMMMMMMMMW0l:;;;;;;;;;:;::::::::::;cOXWMMWOc;:;;;;;;;;;;;;;;;l0WNx::oKWMMMMMM"' >> /etc/bash.bashrc
echo 'echo "MMMMMMMMMMMMMNkc;;::;;;;;;;::::::::::;oXWWMMNx:;;;;;;;;;;;;:;;;;l0WXd::dXMMMMMMM"' >> /etc/bash.bashrc
echo 'echo "MMMMMMMMMMMMMMNkc;;::;;;:;;:;:::::::;:dXWMMW0l:;:;;;;;;;;;::::;;cONKo;:kNMMMMMMM"' >> /etc/bash.bashrc
